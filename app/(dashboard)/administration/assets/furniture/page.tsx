...
export default function FurniturePage() {
  ...
  const load = async () => {
    ...
    const [furnRes, branchRes, userRes] = await Promise.all([
      supabase
        .from('furniture')
        .select('*, branches(name), assigned_to_profile:profiles!furniture_assigned_to_fkey(first_name, last_name)')
  ...
  return (
    <PermissionGuard permission="assets.view" fallback={<div className="p-6 text-center text-gray-500">You don't have permission to view furniture</div>}>
