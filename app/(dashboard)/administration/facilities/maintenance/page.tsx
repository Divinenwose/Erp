...
export default function MaintenanceRequestsPage() {
  ...
  return (
    <PermissionGuard permission="facilities.view" fallback={<div className="p-6 text-center text-gray-500">You don't have permission to view maintenance requests</div>}>
