...
export default function CleanlinessInspectionPage() {
  ...
  return (
    <PermissionGuard permission="inspections.view" fallback={<div className="p-6 text-center text-gray-500">You don't have permission to view cleanliness inspections</div>}>
