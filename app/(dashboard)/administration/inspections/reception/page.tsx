...
const CHECKLIST_ITEMS = [
  ...
  'Waiting area furniture is presentable',
  'Signage is visible and up to date',
  'Visitor sign-in materials are stocked',
  'Lighting is adequate',
  'Reading materials/displays are current',
  'Floor and entrance are clean',
  'Reception staff area is tidy',
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Inspect reception area presentation and readiness"
        breadcrumbs={[
      ...
      >
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>New Reception Inspection</DialogTitle>
            </DialogHeader>
