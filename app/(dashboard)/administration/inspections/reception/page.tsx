...
export default function ReceptionInspectionPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Reception Inspection"
        description="Inspect front desk and reception area"
        breadcrumbs={[
      ...
      >
        <Dialog>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader><DialogTitle>New Reception Inspection</DialogTitle></DialogHeader>
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-3">
                ...
                {['Reception desk is clean and organized', 'Visitor log is maintained', 'Waiting area is tidy', 'Magazines/brochures are current', 'Phone system is functional', 'Signage is clear and visible', 'Lighting is adequate', 'Security equipment is functional'].map((item, i) => (
