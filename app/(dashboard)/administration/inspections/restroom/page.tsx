...
const CHECKLIST_ITEMS = [
  ...
  'Sinks and mirrors are clean',
  'Soap dispensers are stocked',
  'Paper towels/hand dryers are functional',
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Inspect restroom cleanliness and supplies"
        breadcrumbs={[
      ...
      >
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>New Restroom Inspection</DialogTitle>
            </DialogHeader>
