...
export default function RestroomInspectionPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Inspect restroom hygiene and maintenance"
        breadcrumbs={[
      ...
      >
        <Dialog>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader><DialogTitle>New Restroom Inspection</DialogTitle></DialogHeader>
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>Branch</Label>
                  <Select><SelectTrigger><SelectValue placeholder="Select branch" /></SelectTrigger><SelectContent><SelectItem value="main">Main Office</SelectItem></SelectContent></Select>
                </div>
                <div className="space-y-2"><Label>Date</Label><Input type="date" defaultValue={format(new Date(), 'yyyy-MM-dd')} /></div>
              </div>
              <div className="space-y-3">
                <h3 className="font-semibold">Checklist</h3>
                {['Floors are clean and dry', 'Sinks and counters are clean', 'Toilets are clean and functional', 'Soap dispensers are filled', 'Paper towels are stocked', 'Mirrors are clean', 'No unpleasant odors', 'Lighting is functional'].map((item, i) => (
