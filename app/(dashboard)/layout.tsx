...
const routePermissions: Record<string, string> = {
  ...
  '/administration/assets': 'administration.assets.view',
  '/administration/fleet': 'administration.fleet.view',
  '/administration/visitors': 'administration.visitors.view',
  '/administration/work-orders': 'administration.work_orders.view',
